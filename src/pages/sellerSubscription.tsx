...
import DetailSubscriptionSeller from "../components/my_components/detailSubscriptionSeller";
...
export default function SellerSubscription() {
	...
	// 		user_img: "https://placehold.co/48x48",
	...
	const fetchSubs = async () => {
		try {
			const res = await fetch(`${apiUrl}/api/v1/subscriptions/seller`, {
				credentials: "include",
			});
		...
		<>
			...
			<Dialog open={openDialog} onOpenChange={setOpenDialog}>
				<DialogContent className="sm:max-w-7xl overflow-y-auto">
					...
					<DetailSubscriptionSeller data={selectSubscription} />
				</DialogContent>
			</Dialog>
		</>
	);
